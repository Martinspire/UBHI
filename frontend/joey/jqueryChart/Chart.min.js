...
(function ()
{
	...
	var s = e.helpers = {},
		...
		C = (s.calculateScaleRange = function (t, i, e, s, n)
		{
			...
			for (var c = Math.abs(l - r), u = y(c), d = Math.ceil(l / (1 * Math.pow(10, u))) * Math.pow(10, u), p = s ? 0 : Math.floor(r / (1 * Math.pow(10, u))) * Math.pow(10, u), f = d - p, v = Math.pow(10, u), x = Math.round(f / v);
				(x > a || a > 2 * x) && !h;)
				if (x > a) v *= 2, x = Math.round(f / v), x % 1 !== 0 && (h = !0);
				else if (n && u >= 0)
			{
				if (v / 2 % 1 !== 0) break;
	...
	}), e.MultiTooltip = e.Element.extend(
	{
		initialize: function ()
		{
			...
			var t = this.ctx.measureText(this.title)
				.width,
	...
	}), e.Scale = e.Element.extend(
	{
		...
		calculateXLabelRotation: function ()
		{
			...
			var t, i, e = this.ctx.measureText(this.xLabels[0])
				.width,
				s = this.ctx.measureText(this.xLabels[this.xLabels.length - 1])
				.width;
