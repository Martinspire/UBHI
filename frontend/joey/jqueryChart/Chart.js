...
(function ()
{
	...
	Chart.Tooltip = Chart.Element.extend(
	{
		draw: function ()
		{
			...
			var tooltipWidth = ctx.measureText(this.text)
	...
	Chart.MultiTooltip = Chart.Element.extend(
	{
		initialize: function ()
		{
			...
			var titleWidth = this.ctx.measureText(this.title)
				.width,
	...
	Chart.Scale = Chart.Element.extend(
	{
		...
		buildYLabels: function ()
		{
			...
			for (var i = 0; i <= this.steps; i++)
			{
				...
				{
					value: (this.min + (i * this.stepValue))
		...
		calculateXLabelRotation: function ()
		{
			...
			var firstWidth = this.ctx.measureText(this.xLabels[0])
				.width,
				lastWidth = this.ctx.measureText(this.xLabels[this.xLabels.length - 1])
				.width,
				firstRotated,
				lastRotated;
