	...
	}, m.extend = m.fn.extend = function ()
	{
		...
		for ("boolean" == typeof g && (j = g, g = arguments[h] ||
			...
			if (null != (e = arguments[h]))
				for (d in e) a = g[d], c = e[d], g !== c && (j && c && (m.isPlainObject(c) || (b = m.isArray(c))) ? (b ? (b = !1, f = a && m.isArray(a) ? a : []) : f = a && m.isPlainObject(a) ? a :
	...
	var s = function (a)
	{
		...
		}, m = fb.setDocument = function (a)
		{
			...
			}), c.getById = ib(function (a)
			{
				return o.appendChild(a)
					.id = u, !e.getElementsByName || !e.getElementsByName(u)
					.length
			...
			{
				a.innerHTML = "<select msallowclip=''><option selected=''></option></select>", a.querySelectorAll("[msallowclip^='']")
					.length && q.push("[*^$]=" + M + "*(?:''|\"\")"), a.querySelectorAll("[selected]")
					.length || q.push("\\[" + M + "*(?:value|" + L + ")"), a.querySelectorAll(":checked")
			...
			}), ib(function (a)
			{
				...
				b.setAttribute("type", "hidden"), a.appendChild(b)
					...
					.length && q.push("name" + M + "*[*^$|!~]?="), a.querySelectorAll(":enabled")
		...
		}, e = fb.getText = function (a)
		{
			...
			pseudos:
			{
				...
				lang: hb(function (a)
				{
					return W.test(a || "") || fb.error("unsupported lang: " + a), a = a.replace(cb, db)
						.toLowerCase(),
						function (b)
						{
							var c;
		...
		pb.prototype = d.filters = d.pseudos, d.setFilters = new pb, g = fb.tokenize = function (a, b)
		{
			...
			return b ? h.length : h ? fb.error(a) : z(a, i)
				.slice(0)
		};
			...
			for (var b, c, e, f = a.length, g = d.relative[a[0].type], h = g || d.relative[" "], i = g ? 1 : 0, k = rb(function (a)
				...
				else
				{
					if (c = d.filter[a[i].type].apply(null, a[i].matches), c[u])
					{
						...
						return vb(i > 1 && sb(m), i > 1 && qb(a.slice(0, i - 1)
								.concat(
								{
									value: " " === a[i - 2].type ? "*" : ""
								}))
		...
		return h = fb.compile = function (a, b)
			...
			.sort(B)
			.join("") === u, c.detectDuplicates = !!l, m(), c.sortDetached = ib(function (a)
			{
		...
		remove: function (a, b, c, d, e)
		{
			...
			if (r && (k = r.events))
			{
				...
				while (j--)
					...
					{
						l = m.event.special[o] ||
						{}, o = (d ? l.delegateType : l.bindType) || o, n = k[o] || [], h = h[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), i = f = n.length;
